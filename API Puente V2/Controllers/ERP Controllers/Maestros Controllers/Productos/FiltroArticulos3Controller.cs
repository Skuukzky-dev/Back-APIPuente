...
namespace API_Puente_V2.Controllers.ERP_Controllers.Maestros_Controllers.Productos
{
    ...
    [ApiController]
    public class FiltroArticulos3Controller : ControllerBase
    {
        // GET: api/<FiltroArticulos3Controller>
        [HttpGet("GetList")]
        [SwaggerResponse(200, "OK", typeof(cResponseFiltroArticulos3))]
        ...
        {
            GESI.CORE.API.BO.cResponseFiltroArticulos3? oRespuesta = new GESI.CORE.API.BO.cResponseFiltroArticulos3();
            ...
            try
            {
                ...
                oRespuesta = await GESI.CORE.API.PUENTE.BLL.FiltroArticulos3Mgr.GetList(URLBackend, Token, empresaID, sucursalID, GESI.CORE.API.PUENTE.BLL.Endpoints.strAlmacenesGetList, pageNumber, pageSize);
