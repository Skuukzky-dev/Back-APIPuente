...
namespace API_Puente_V2.Controllers.ERP_Controllers.Maestros_Controllers
{
    ...
    [ApiController]
    public class SubSubRubrosController : ControllerBase
    {
        [HttpGet("GetList")]
        [SwaggerResponse(200, "OK", typeof(cResponseSubSubRubros))]
        ...
        {
            GESI.CORE.API.BO.cResponseSubSubRubros? oRespuesta = new GESI.CORE.API.BO.cResponseSubSubRubros();
            ...
            try
            {
                ...
                oRespuesta = await GESI.CORE.API.PUENTE.BLL.SubSubRubrosMgr.GetList(URLBackend, Token, empresaID, sucursalID, GESI.CORE.API.PUENTE.BLL.Endpoints.strSubSubRubrosGetList, pageNumber, pageSize);
