...
namespace API_Puente_V2.Controllers.ERP_Controllers.Maestros_Controllers.Productos
{
    ...
    [ApiController]
    public class FiltroArticulos2Controller : ControllerBase
    {
        // GET: api/<FiltroArticulos2Controller>
        [HttpGet("GetList")]
        [SwaggerResponse(200, "OK", typeof(cResponseFiltroArticulos2))]
        ...
        {
            GESI.CORE.API.BO.cResponseFiltroArticulos2? oRespuesta = new GESI.CORE.API.BO.cResponseFiltroArticulos2();
            ...
            try
            {
                ...
                oRespuesta = await GESI.CORE.API.PUENTE.BLL.FiltroArticulos2Mgr.GetList(URLBackend, Token, empresaID, sucursalID, GESI.CORE.API.PUENTE.BLL.Endpoints.strAlmacenesGetList, pageNumber, pageSize);
