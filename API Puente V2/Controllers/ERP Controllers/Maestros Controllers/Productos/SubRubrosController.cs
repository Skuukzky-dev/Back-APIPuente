...
namespace API_Puente_V2.Controllers.ERP_Controllers.Maestros_Controllers
{
    ...
    {
        // GET: api/<SubRubrosController>
        [HttpGet("GetList")]
        [SwaggerResponse(200, "OK", typeof(cResponseSubRubros))]
        ...
        {
            GESI.CORE.API.BO.cResponseSubRubros? oRespuesta = new GESI.CORE.API.BO.cResponseSubRubros();
            ...
            try
            {
                ...
                oRespuesta = await GESI.CORE.API.PUENTE.BLL.SubRubrosMgr.GetList(URLBackend, Token, empresaID, sucursalID, Endpoints.strSubRubrosGetList, pageNumber, pageSize);
