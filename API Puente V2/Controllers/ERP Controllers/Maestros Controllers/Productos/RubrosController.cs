...
namespace API_Puente_V2.Controllers.ERP_Controllers.Maestros_Controllers
{
    ...
    {
        // GET: api/<RubrosController>
        [HttpGet("GetList")]
        [SwaggerResponse(200, "OK", typeof(cResponseRubros))]
        ...
        {
            GESI.CORE.API.BO.cResponseRubros? oRespuesta = new GESI.CORE.API.BO.cResponseRubros();
            ...
            try
            {
                ...
                oRespuesta = await GESI.CORE.API.PUENTE.BLL.RubroMgr.GetList(URLBackend, Token,empresaID,sucursalID, GESI.CORE.API.PUENTE.BLL.Endpoints.strRubrosGetList, pageNumber, pageSize);
