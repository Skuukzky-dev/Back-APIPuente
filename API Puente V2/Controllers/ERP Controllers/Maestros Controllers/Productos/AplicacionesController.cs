...
namespace API_Puente_V2.Controllers.ERP_Controllers.Maestros_Controllers.Productos
{
    ...
    {
        // GET: api/<AplicacionesController>
        [HttpGet("GetList")]
        [SwaggerResponse(200, "OK", typeof(cResponseAplicacionesProducto))]
        ...
        {
            GESI.CORE.API.BO.cResponseAplicacionesProducto? oRespuesta = new GESI.CORE.API.BO.cResponseAplicacionesProducto();
            ...
            try
            {
                ...
                oRespuesta = await GESI.CORE.API.PUENTE.BLL.ProductosMgr.GetAplicacionesProductos(URLBackend,Endpoints.strAplicacionesProductosGetList,Token,empresaID,sucursalID,pageNumber,pageSize);
