...
namespace API_Puente_V2.Controllers.ERP_Controllers.Maestros_Controllers.General
{
    ...
    public class VendedoresController : ControllerBase
    {
        ...
        [HttpGet("GetList")]
        [SwaggerResponse(200, "OK", typeof(cResponseVendedores))]
        ...
        {
            GESI.CORE.API.BO.cResponseVendedores? oRespuesta = new GESI.CORE.API.BO.cResponseVendedores();
            ...
            try
            {
                ...
                oRespuesta = await GESI.CORE.API.PUENTE.BLL.VendedoresMgr.GetList(URLBackend, Token, empresaID, sucursalID, GESI.CORE.API.PUENTE.BLL.Endpoints.strAlmacenesGetList, pageNumber, pageSize);
        ...
        [HttpGet("GetItem")]
        [SwaggerResponse(200, "OK", typeof(cResponseVendedor))]
        public async Task<IActionResult> GetItem(int vendedorID = 0)
        {
            GESI.CORE.API.BO.cResponseVendedor? oRespuesta = new GESI.CORE.API.BO.cResponseVendedor();
            Stopwatch stop = new Stopwatch();
            stop.Start();
            ...
            try
            {
                ...
                oRespuesta = await GESI.CORE.API.PUENTE.BLL.VendedoresMgr.GetItem(URLBackend, Token, empresaID, sucursalID, GESI.CORE.API.PUENTE.BLL.Endpoints.strVendedoresGetItem, vendedorID);
