...
namespace API_Puente_V2.Controllers.ERP_Controllers.Maestros_Controllers.General
{
    ...
    public class MediosDePagoController : ControllerBase
    {
        ...
        [HttpGet("GetList")]
        [SwaggerResponse(200, "OK", typeof(cResponseMediosDePagos))]
        ...
        {
            GESI.CORE.API.BO.cResponseMediosDePagos? oRespuesta = new GESI.CORE.API.BO.cResponseMediosDePagos();
            ...
            try
            {
                ...
                oRespuesta = await GESI.CORE.API.PUENTE.BLL.MediosDePagoMgr.GetList(URLBackend,Token, GESI.CORE.API.PUENTE.BLL.Endpoints.strMediosDePagoGetList,empresaID,sucursalID,pageNumber,pageSize);
        ...
        [HttpGet("GetItem")]
        [SwaggerResponse(200, "OK", typeof(cResponseMedioDePago))]
        public async Task<IActionResult> GetItem(int medioDePagoID = 0)
        {
            GESI.CORE.API.BO.cResponseMedioDePago? oRespuesta = new GESI.CORE.API.BO.cResponseMedioDePago();
            ...
            try
            {
                ...
                oRespuesta = await GESI.CORE.API.PUENTE.BLL.MediosDePagoMgr.GetItem(URLBackend,Token,GESI.CORE.API.PUENTE.BLL.Endpoints.strMediosDePagoGetItem,empresaID,sucursalID,medioDePagoID);
