...
namespace API_Puente_V2.Controllers.ERP_Controllers.Maestros_Controllers.General
{
    ...
    public class ZonasController : ControllerBase
    {
        ...
        [HttpGet("GetList")]
        [SwaggerResponse(200, "OK", typeof(cResponseZonas))]
        ...
        {
            GESI.CORE.API.BO.cResponseZonas? oRespuesta = new GESI.CORE.API.BO.cResponseZonas();
            ...
            try
            {
                ...
                oRespuesta = await GESI.CORE.API.PUENTE.BLL.ZonasMgr.GetList(URLBackend, Token, GESI.CORE.API.PUENTE.BLL.Endpoints.strZonasGetList, empresaID, sucursalID, pageNumber, pageSize);
