...
namespace API_Puente_V2.Controllers.ERP_Controllers.Maestros_Controllers.General
{
    ...
    public class PaisesController : ControllerBase
    {
        ...
        [HttpGet("GetList")]
        [SwaggerResponse(200, "OK", typeof(cResponsePaises))]
        ...
        {
            GESI.CORE.API.BO.cResponsePaises? oRespuesta = new GESI.CORE.API.BO.cResponsePaises();
            ...
            try
            {
                ...
                oRespuesta = await GESI.CORE.API.PUENTE.BLL.PaisesMgr.GetList(URLBackend, Token, GESI.CORE.API.PUENTE.BLL.Endpoints.strPaisesGetList,empresaID, sucursalID, pageNumber, pageSize);
        ...
        [HttpGet("GetItem")]
        [SwaggerResponse(200, "OK", typeof(cResponsePais))]
        public async Task<IActionResult> GetItem(int paisID = 0)
        {
            GESI.CORE.API.BO.cResponsePais? oRespuesta = new GESI.CORE.API.BO.cResponsePais();
            ...
            try
            {
                ...
                oRespuesta = await GESI.CORE.API.PUENTE.BLL.PaisesMgr.GetItem(URLBackend, Token, GESI.CORE.API.PUENTE.BLL.Endpoints.strPaisesGetItem, empresaID, sucursalID,paisID);
