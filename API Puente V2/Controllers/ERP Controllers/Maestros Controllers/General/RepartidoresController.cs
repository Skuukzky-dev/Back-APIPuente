...
namespace API_Puente_V2.Controllers.ERP_Controllers.Maestros_Controllers.General
{
    ...
    {
        // GET: api/<RepartidoresController>
        [HttpGet("GetList")]
        [SwaggerResponse(200, "OK", typeof(cResponseRepartidores))]
        ...
        {
            GESI.CORE.API.BO.cResponseRepartidores? oRespuesta = new GESI.CORE.API.BO.cResponseRepartidores();
            ...
            try
            {
                ...
                oRespuesta = await GESI.CORE.API.PUENTE.BLL.RepartidoresMgr.GetList(URLBackend, Token, empresaID, sucursalID, GESI.CORE.API.PUENTE.BLL.Endpoints.strRepartidoresGetList, pageNumber, pageSize);
        ...
        [HttpGet("GetItem")]
        [SwaggerResponse(200, "OK", typeof(cResponseRepartidor))]
        public async Task<IActionResult> GetItem(int repartidorID = 0)
        {
            GESI.CORE.API.BO.cResponseRepartidor? oRespuesta = new GESI.CORE.API.BO.cResponseRepartidor();
            ...
            try
            {
                ...
                oRespuesta = await GESI.CORE.API.PUENTE.BLL.RepartidoresMgr.GetItem(URLBackend, Token, empresaID, sucursalID, GESI.CORE.API.PUENTE.BLL.Endpoints.strRepartidoresGetItem,repartidorID);
