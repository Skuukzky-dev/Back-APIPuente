...
namespace API_Puente_V2.Controllers.ERP_Controllers.Maestros_Controllers.General
{
    ...
    [ApiController]
    public class CajasBancosController : ControllerBase
    {
        // GET: api/<CajasBancosController>
        [HttpGet("GetList")]
        [SwaggerResponse(200, "OK", typeof(cResponseCajasBancos))]
        ...
        {
            GESI.CORE.API.BO.cResponseCajasBancos? oRespuesta = new GESI.CORE.API.BO.cResponseCajasBancos();
            ...
            try
            {
                ...
                oRespuesta = await GESI.CORE.API.PUENTE.BLL.CajasBancosMgr.GetList(URLBackend, Token, empresaID, sucursalID, GESI.CORE.API.PUENTE.BLL.Endpoints.strCajasBancosGetList, pageNumber, pageSize);
        ...
        // GET api/<CajasBancosController>/5
        [HttpGet("GetItem")]
        [SwaggerResponse(200, "OK", typeof(cResponseCajaBanco))]
        public async Task<IActionResult> GetItem(int cajabancoID = 0)
        {
            GESI.CORE.API.BO.cResponseCajaBanco? oRespuesta = new GESI.CORE.API.BO.cResponseCajaBanco();
            ...
            try
            {
                ...
                oRespuesta = await GESI.CORE.API.PUENTE.BLL.CajasBancosMgr.GetItem(URLBackend, Token, empresaID, sucursalID, GESI.CORE.API.PUENTE.BLL.Endpoints.strCajasBancosGetItem, cajabancoID);
