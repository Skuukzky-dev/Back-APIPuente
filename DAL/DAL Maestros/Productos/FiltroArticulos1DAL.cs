...
{
    public class FiltroArticulos1DAL
    {
        /// <summary>
        /// Devuellve una lista de Filtros Articulos 1
        /// </summary>
            ...
            try
            {
                ...
                using (var httpClient = new HttpClient(handler))
                {
                    using (var request = new HttpRequestMessage(new HttpMethod("GET"), URLBackend + endpoint + "?" + cadenaConParametros))
                    {
                        ...
                        oRespuesta = JsonConvert.DeserializeObject<cResponseFiltroArticulos1>(respuesta);
